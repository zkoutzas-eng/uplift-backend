...
app.post('/api/employees', async (req, res) => {
  ...
  // Update employee count — get total count rather than just this batch
  ...
  // Send invite emails — wrapped so an email failure never breaks the response
...
app.post('/api/employees/resend', async (req, res) => {
  ...
  try {
    ...
    console.error('Failed to resend invite:', emailErr.message);
  }
