...
async function generateAndSendEmail(employee, preferences) {
  ...
  await resend.emails.send({
    ...
    to: employee.email,
    subject,
    // Plain text version — critical for inbox placement, tells Gmail this is a personal email
    text: `${emailBody}\n\n—\nThe Uplift team · hello@upliftau.com\n\nUpdate your preferences: https://upliftau.com/setup?employee=${employee.id}&update=true\nUnsubscribe: https://upliftau.com/unsubscribe?employee=${employee.id}`,
    html: `
      <div style="font-family: Georgia, serif; max-width: 560px; margin: 0 auto; padding: 40px 20px; color: #161210;">
        ...
        <div style="margin-top: 32px; padding-top: 24px; border-top: 1px solid #E8DFD0; font-size: 13px; color: #9C8472;">
          The Uplift team · hello@upliftau.com
          <br>
          <a href="https://upliftau.com/setup?employee=${employee.id}&update=true"
             style="color: #9C8472; text-decoration: underline; font-size: 12px;">
            Update your preferences
          </a>
          &nbsp;·&nbsp;
          <a href="https://upliftau.com/unsubscribe?employee=${employee.id}"
             style="color: #9C8472; text-decoration: underline; font-size: 12px;">
            Unsubscribe
          </a>
        </div>
